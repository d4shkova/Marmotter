...
pub use dcc::{
    ...
    local_address_towards as dcc_local_address_towards, plan_target as dcc_plan_target,
    receive_passive as dcc_receive_passive, CancelHandle as DccCancelHandle,
    CancelSignal as DccCancelSignal, DownloadOptions as DccDownloadOptions,
    PassiveOptions as DccPassiveOptions, TransferTarget as DccTransferTarget, DEFAULT_DCC_TIMEOUT,
};
